...
public class Basketball extends AppCompatActivity {
    ...
    private RecyclerView BasketballRecyclerList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MatchRef = FirebaseDatabase.getInstance().getReference().child("Basketball");

        BasketballRecyclerList = (RecyclerView) findViewById(R.id.basketballRecyclerList);
        BasketballRecyclerList.setLayoutManager(new LinearLayoutManager(this));
    }
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Match, MatchViewHolder> adapter = new FirebaseRecyclerAdapter<Match, MatchViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull MatchViewHolder holder, final int position, @NonNull Match model) {
                ...
                Picasso.get().load(model.getTeam1Image()).placeholder(R.drawable.basketball_logo).into(holder.team1Image);
                Picasso.get().load(model.getTeam2Image()).placeholder(R.drawable.basketball_logo).into(holder.team2Image);
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent matchIntent = new Intent(Basketball.this, TeamSelectionActivity.class);
        ...
        BasketballRecyclerList.setAdapter(adapter);
