...
public class Football extends AppCompatActivity {
    ...
    private RecyclerView FootballRecyclerList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MatchRef = FirebaseDatabase.getInstance().getReference().child("Football");

        FootballRecyclerList = (RecyclerView) findViewById(R.id.footballRecyclerList);
        FootballRecyclerList.setLayoutManager(new LinearLayoutManager(this));
    }
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Match, MatchViewHolder> adapter = new FirebaseRecyclerAdapter<Match, MatchViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull MatchViewHolder holder, final int position, @NonNull Match model) {
                ...
                Picasso.get().load(model.getTeam1Image()).placeholder(R.drawable.football_logo).into(holder.team1Image);
                Picasso.get().load(model.getTeam2Image()).placeholder(R.drawable.football_logo).into(holder.team2Image);
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent matchIntent = new Intent(Football.this, TeamSelectionActivity.class);
        ...
        FootballRecyclerList.setAdapter(adapter);
